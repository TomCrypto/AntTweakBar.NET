...
namespace AntTweakBar
{
    ...
    public sealed class StructVariable<T> : Variable where T : struct
    {
        ...
        /// </summary>
        private static void InitStructVariable(Variable var, String id)
        {
            ...
            // here parse the struct into a StructMemberInfo dict and use Tw.DefineStruct
            // how to parse it? what if we want to exclude some members? custom summary?
        ...
        public StructVariable(Bar bar, T initialValue = default(T), String def = null)
            : base(bar, InitStructVariable, def)
        {
